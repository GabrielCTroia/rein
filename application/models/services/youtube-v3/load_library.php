 ...
 */
 ...
 require_once ( APPPATH . 'lib/google/src/Google_Client.php' );
 require_once ( APPPATH . 'lib/google/src/contrib/Google_YouTubeService.php' );
...
/* Location: ./application/models/services/youtube/load_library.php */